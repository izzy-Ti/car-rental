        ...
        {bookings.length === 0 ? (
          <div className="text-center py-12">
            ...
            <div className="mt-6">
              <Link
                to="/cars"
                className="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-[#F87060] hover:bg-[#e65a4a] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#F87060]"
              >
                Browse Cars
              </Link>
            </div>
                      ...
                      <div className="flex items-start space-x-4">
                        ...
                        <div className="flex-1">
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm text-gray-600">
                            ...
                            <div className="flex items-center space-x-2">
                              <svg className="w-4 h-5 text-[#F87060]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
